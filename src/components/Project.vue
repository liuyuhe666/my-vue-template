...
<template>
  <a
    :href="url"
    target="_blank"
    class="relative flex flex-col items-stretch duration-300 ease-out p-7 sm:p-3 group rounded-2xl"
  >
    <span
    ...
    >
      ...
      <span class="block w-full px-1 mt-5 mb-1 sm:mt-3">
        ...
        <span class="text-sm text-neutral-600 dark:text-neutral-400 block truncate">{{ description }}</span>
      </span>
    </span>
  </a>
</template>
